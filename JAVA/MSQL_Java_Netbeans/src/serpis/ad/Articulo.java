...
public class Articulo {
    ...
    public Articulo(String nombre, String precio, String categoria_fk) {
        //this.id = Long.parseLong(id);
        this.nombre = nombre;
        this.precio = Double.parseDouble(precio);
        this.categoria_fk = Long.parseLong(categoria_fk);
    ...
    public String getCategoriaNombre(){
        ...
        try {
            ...
            stmt.setString(1, this.getCategoria_fk_String());

            ResultSet resultSet = stmt.executeQuery();
            resultSet.next();
            retorno= resultSet.getString("nombre");
    ...
    public static void insert(Articulo articulo) {
        ...
        try {
            ...
            stmt.setLong(3, articulo.getCategoria_fk());
    ...
    public static String[][] categorias(){
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                auxLista.add(id);
                auxLista.add(nombre);
                lista.add(auxLista.toArray(new String[auxLista.size()]));
            }
